...
Extract five values:
- `VARIANT`: the harness variant (e.g. `harness-claude-github`, `harness-claude-github-railway`)
...
```json
{
  ...
  "files": {
    "templates/harness-claude-github/workflows/file.yml": "<base64-encoded content>",
