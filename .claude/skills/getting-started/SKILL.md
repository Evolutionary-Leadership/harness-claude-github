...
inherits that random codename instead of describing the work.
...
GitHub Action to create `feature/<slug>`. Run it once, early. It is
idempotent and a no-op off a `claude/` branch.
